...
public class PeopleNearbyMap extends Activity{  
	...
	public BDLocationListener myListener = new MyLocationListener();
        ...
        public void onCreate(Bundle savedInstanceState){  
        	...
        	setContentView(R.layout.peoplenearbymap);  
        	...
        	mMapController.setZoom(11);//设置地图zoom级别 
 ...
 //transfer the location
               ...
               try {
      				...
      				specifiedFriendsLocation.accumulate("requestType", "peopleNearbyLocation");
      			    ...
      			    if(httpResponse.getStatusLine().getStatusCode()==200){	
      				    ...
      				    if(responseData.getString("flag").equals("peopleNearbyLocationSuccess")){
      				    	Log.e("1","exist");
      				     ...
      				     /** 
      		               ...
      		               // 用给定的经纬度构造GeoPoint，单位是微度 (度 * 1E6)  
       		               ...
       		               GeoPoint pMe = new GeoPoint((int) (location.getLatitude() * 1E6), (int) (location.getLongitude() * 1E6));  
       		            MyOverlayItem itemMe = new MyOverlayItem(pMe,BigPackage.username,BigPackage.username);
      				    ...
      				    else if(responseData.getString("flag").equals("peopleNearbyLocationNull")){
      				    	Log.e("1","notexist");
      				    }
      			    }
